...
function printMoreThanWeek(data, criticalIndex) {
    ...
    document.getElementById("forgotten").innerHTML =
        '<table class="table table-striped"><thead><tr><td>Name</td><td>FB Link</td></tr></thead><tbody><tr><th>' + data[criticalIndex][0] + '</th><th>https://www.facebook.com/' + data[criticalIndex][2] + '</th></tr>' +
        + '<tr><th>' + data[criticalIndex-1][0] + '</th><th>https://www.facebook.com/' + data[criticalIndex-1][2] + '</th></tr></tbody></table>';
