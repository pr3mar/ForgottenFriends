...
function printMoreThanWeek(data, criticalIndex) {
    ...
    /*document.getElementById("forgotten").innerHTML =
        ...
        '<th><a href="https://www.facebook.com/'+ data[data.length - 2][2] + '">' + data[data.length - 2][0] + '</a></th></tr>' +
            '<tr><th><a href="https://www.facebook.com/'+ data[criticalIndex - 2][2] + '">' + data[criticalIndex-2][0] +'</a></th>' +
        '<th><a href="https://www.facebook.com/'+ data[data.length - 3][2] + '">' + data[data.length -3][0] + '</a></th></tr>' +
